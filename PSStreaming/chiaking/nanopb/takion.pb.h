...
#define tkproto_TakionMessage_type_ENUMTYPE tkproto_TakionMessage_PayloadType
...
#define tkproto_LogMessage_level_ENUMTYPE tkproto_LogMessage_LogLevel


#define tkproto_ClientMetric_category_ENUMTYPE tkproto_ClientMetric_Category


#define tkproto_HeaderRequestPayload_type_ENUMTYPE tkproto_HeaderRequestPayload_HeaderType

#define tkproto_DebugOption_type_ENUMTYPE tkproto_DebugOption_Type

#define tkproto_OverlayPayload_location_ENUMTYPE tkproto_OverlayPayload_LogLocation





#define tkproto_XmbCommandPayload_command_ENUMTYPE tkproto_XmbCommandPayload_XmbCommand




#define tkproto_ControllerConnectionPayload_controller_type_ENUMTYPE tkproto_ControllerConnectionPayload_ControllerType
...
#define tkproto_DeepLinkPayload_deep_link_type_ENUMTYPE tkproto_DeepLinkPayload_DeepLinkType

#define tkproto_MicInfoPayload_mic_info_type_ENUMTYPE tkproto_MicInfoPayload_MicInfoType

#define tkproto_DirectMessagePayload_direct_message_type_ENUMTYPE tkproto_DirectMessagePayload_DirectMessageType
#define tkproto_DirectMessagePayload_destination_ENUMTYPE tkproto_DirectMessagePayload_Destination




#define tkproto_SenkushaPayload_command_ENUMTYPE tkproto_SenkushaPayload_Command
...
#define TKPROTO_TAKION_PB_H_MAX_SIZE             tkproto_SenkushaPayload_size
