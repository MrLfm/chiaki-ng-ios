...
// 用于管理和处理 Chiaki 流连接的代码实现，涉及到音视频数据流的接收、反馈和处理
...
extern void processDecryptedDataFromC(void *data, size_t size);
...
typedef void (*ChiakiStreamConnectionCallback)(ChiakiTakionAVPacket *av);
